...
public class ImageLocalSpecialtiesService
{
    private readonly ICloudinaryService _cloudinaryService;

    public ImageLocalSpecialtiesService(ICloudinaryService cloudinaryService)
    {
        _cloudinaryService = cloudinaryService;
    }

    public async Task<List<String>> AddImageLocalSpecialties(List<IFormFile> file)
    {
    ...
    public async Task<bool> DeleteImageLocalSpecialties(string imageUrl)
    {
