...
public class ImageManagementEventAndFestivalServices
{
    private readonly ICloudinaryService _cloudinaryService;

    public ImageManagementEventAndFestivalServices(ICloudinaryService cloudinaryService)
    {
        _cloudinaryService = cloudinaryService;
    }

    public async Task<List<String>> AddImageEventAndFestival(List<IFormFile> file)
    {
    ...
    public async Task<bool> DeleteImageEventAndFestival(string imageUrl)
    {
